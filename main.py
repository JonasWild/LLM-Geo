...
TEST_CASES = [
    {
        "name": "urban_areas_png",
        "task": "Finde die urbane Gebiete mittels overpass zwischen Magedburg und Hohes Holz und visualisiere sie",
        "expect_success": True
    },
    {
        "name": "urban_areas_sitaware",
        "task": "Finde die urbane Gebiete mittels overpass zwischen Magedburg und Hohes Holz und stelle sie als neuen Layer “urbaneGebiete” auf dem SitaWare Plan “LayerTest” dar.",
        "expect_success": True
    }
]
